...
`,f("caret-right-filled"),d(":where(details[data-ws])")`
    @color: @primary;
    @padding: 8px;
...
`;const C="caret-down-filled";f(C),d("ws-option")`
    ${E("@layer-element","@layer-fill")}
...
`,d("@font-face",null)`
    ...
    *src:
        ...
        format("woff2")
    ;
`;const N=e=>{const t=(e=>{if(""===e||null===e)return;const t=c(o({raw:[e]})),a=m(t.join("\n"));if(x[a]=(x[a]??0)+1,x[a]>1)return a;const n=t.map((e=>e.replaceAll("&",`[data-wsid="${a}"]`)));return r.sheet.insertRule(`@layer ws.macro { ${n.join("\n")} }`,r.sheet.cssRules.length),a})(e.dataset?.ws??"");void 0!==t?e.dataset.wsid=t:delete e.dataset?.wsid};new MutationObserver((e=>{const t=new Set(Array.from(e,(e=>[e.target,...Array.from(e.addedNodes,(e=>[e,...e.querySelectorAll?.("*")||[]]))])).flat(3));for(const e of t)N(e)})).observe(document.body,{subtree:!0,attributes:!0,childList:!0,attributeFilter:["data-ws"]});for(const e of document.querySelectorAll("*"))N(e);export{d as component,w as localMacro,l as macro,f as preloadIcons,y as version,v as x};
