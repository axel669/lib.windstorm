...
<style>
    :host {
        ...
        --max-height: 250px;
        --c1: hsl(var(--color), var(--layer-border));
        --c2: hsl(var(--color), var(--layer-surface));
        display: inline-grid;
        ...
        padding: 4px;
        --modal-transition: var(--select-cancel, visibility var(--anim-time) linear);
        --popover-transition: var(--select-cancel, opacity var(--anim-time) ease-out);
        --select-transition: var(--select-cancel, transform var(--anim-time) ease-out);
    }
