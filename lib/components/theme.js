...
macro("#theme.tron")`
    ...
    @background-layer: hsl(184, 70%, 5%);
    @background-element: hsl(184, 70%, 10%);

    @text-color-normal: hsl(184, 0%, 95%);
    @text-color-secondary: hsl(184, 0%, 65%);
    @text-color-fill: hsl(184, 0%, 5%);
...
macro("#theme.dark")`
    ...
    @background-layer: hsl(184, 30%, 15%);
    @background-element: hsl(184, 30%, 20%);
...
macro("#theme.light")`
    ...
    @background: hsl(184, 0%, 98%);
    @background-layer: hsl(184, 70%, 95%);
    @background-element: hsl(184, 70%, 90%);

    @text-color-normal: hsl(184, 0%, 5%);
    @text-color-secondary: hsl(184, 0%, 15%);
    @text-color-fill: hsl(184, 0%, 95%);
