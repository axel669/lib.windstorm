...
macro("variant.outline")`b: 1px solid @color;`
macro("variant.fill")`@text-color: @text-color-fill; @fill-color: @color;`
macro("variant.lined")`b.w: 0px; b.b.w: @border-size; bg.c: transparent; r: 0px;`
macro("variant.lined-fill")`b.w: 0px; b.b.w: @border-size; r.b: 0px;`
