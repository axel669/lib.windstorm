...
macro("variant.outline")`b.w: 1px;`
macro("variant.fill")`@text-color: @alt-color; @fill-color: @core-color; @active: @alt-color;`
macro("variant.lined")`b.w: 0px; b.b.w: @border-size; r.b: 0px;`
...
macro("elevate")`sh.box: 0px 2px 3px @shadow-color;`
macro("elevated")`sh.box: 0px 2px calc(%arg * 3px) @shadow-color;`
macro("#animate")`
