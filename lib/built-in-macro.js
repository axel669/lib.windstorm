...
macro("gr.area")`*grid-template-areas: %arg;`
...
macro("t.c")`*color: %arg;`
macro("t.dec")`*text-decoration: %arg;`
...
macro("fl-center")`fl.cross: center; fl.main: center;`
...
macro("$adorn")`disp: flex; fl-center; p: 4px;`
macro("$outline")`b.w: 1px; b.c: @color;`
macro("$color")`@color: %arg;`
macro("$compact")`p: 0px 8px;`
macro("$fill")`@text-color: @text-color-fill; @fill-color: @color;`
macro("$lined")`b.w: 0px; b.b.w: @border-size; bg.c: transparent; r: 0px;`
macro("$lined-fill")`b.w: 0px; b.b.w: @border-size; r.b: 0px;`
...
macro("$subtitle-text")`t.sz: @text-size-subtitle; flex; fl.main: center; p: 0px 8px;`
macro("$title-text")`t.sz: @text-size-title; flex; fl.main: center; p: 4px 8px;`
macro("$elevate")`sh.box: 0px 2px 4px @shadow-color;`

macro(".title")`*grid-area: title;`
macro(".action")`*grid-area: action;`
macro(".menu")`*grid-area: menu;`

macro(".content")`*grid-area: content;`
macro(".header")`*grid-area: header;`
macro(".footer")`*grid-area: footer;`
