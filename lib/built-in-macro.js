...
macro("raise")`sh.box: 0px calc(%arg * 1px + 2px) calc(%arg * 1px + 1px) -1px @shadow-color; z: +%arg;`
...
macro("layout.3x3-center")`
    ...
    gr.cols:
        ...
        @width
        [content-end right-start]
        1fr
        [right-end top-end bottom-end]
    ;
    gr.rows:
        ...
        @height
        [content-end bottom-start]
        1fr
        [bottom-end left-end right-end]
    ;
`
