...
createMacro("$subtitle-text")`[t.sz @text-size-subtitle] [flex] [fl.main center] [p 0px 4px]`
createMacro("$title-text")`[t.sz @text-size-title] [flex] [fl.main center] [p 4px]`
createMacro("$elevate")`[sh.box:not(:hover):not(:disabled) 0px 2px 4px @shadow-color]`
