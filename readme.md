...
```html
<script src="https://cdn.jsdelivr.net/npm/@axel669/windstorm@0.4.5/dist/browser.js"></script>
```

### CDN Link (module)
```js
// Only scanning, no functions
import "https://cdn.jsdelivr.net/npm/@axel669/windstorm@0.4.5/dist/module.js"
// Import functions + scanning
import ws from "https://cdn.jsdelivr.net/npm/@axel669/windstorm@0.4.5/dist/module.js"
